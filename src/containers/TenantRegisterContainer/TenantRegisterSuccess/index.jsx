...
import { FiCheckCircle, FiClock, FiHome, FiMail } from "react-icons/fi";
import { useNavigate } from "react-router-dom";
import { notifier } from "../../../components/Notifier";
import Button from "../../../components/Button";

const TenantRegisterSuccess = () => {
      ...
      <div className="space-y-6 max-w-lg">
        <div>
          ...
          <p className="text-sm text-gray-600 leading-relaxed">
            Welcome to{" "}
            <span className="text-blue-600 font-semibold">SofDoc</span>! We've
        ...
        <div className="flex items-center justify-start gap-3 text-sm text-gray-600 bg-gray-200 rounded-xl p-4">
          ...
          <span className="text-start">
            The email usually arrives within 1-2 minutes. Check your spam folder
            if you don't see it.
          </span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
          ...
          <Button
            ...
            onClick={() => notifier.success("Email Sent")}
            variant="secondry"
          />
        </div>
...
export default TenantRegisterSuccess;
